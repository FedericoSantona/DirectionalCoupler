...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--w-range", type=float, nargs=3, default=(1.05, 1.15, 0.01), metavar=("MIN", "MAX", "STEP"))
    parser.add_argument("--g-range", type=float, nargs=3, default=(0.26, 0.32, 0.01), metavar=("MIN", "MAX", "STEP"))
    parser.add_argument("--t-range", type=float, nargs=3, default=(0.28, 0.28, 0.01), metavar=("MIN", "MAX", "STEP"))
    ...
    parser.add_argument("--hard-min", type=float, default=-0.5)
    parser.add_argument("--hard-max", type=float, default=0.5)
    ...
    parser.add_argument("--csv", type=str, default="results/sweeps/tune_geometry_denser.csv", help="Path to save detailed CSV results")
